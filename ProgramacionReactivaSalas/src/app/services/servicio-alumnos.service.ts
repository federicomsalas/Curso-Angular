...
export class ServicioAlumnosService {
 ...
 // tiempoRestanteSubject: Subject<any>;
  ...
  constructor() {
    ...
    console.log("constr SERV");  
    console.log("Length" ,this.alumnos);
    this.alumnos = [];
    let repeticionInicial = true;
    ...
    this.alumnosObservable = new Observable<any>((suscriptor) =>
      {
            ...
            let max = this.getMinMax(10,50);
              ...
              //this.alumnosSubject.next(this.alumnos);
               ...
               console.log(this.cantidadRepeticionesSubject);
    
               console.log("Observed" ,this.cantidadRepeticionesSubject.observed);
               console.log("isStopped" ,this.cantidadRepeticionesSubject.isStopped);

         /*     if (repeticionInicial)
              {
                this.repeticiones++;
                this.cantidadRepeticionesSubject.next(this.repeticiones); 
                repeticionInicial = false;                
              }*/
